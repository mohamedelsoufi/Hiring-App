    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-building"></i> @lang('site.'.$module_name_plural)</li>
            </ol>
        </section>
                    ...
                    <table class="table table-hover">
                        ...
                        <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th>@lang('site.mobile_number1')</th>
                                    <th>@lang('site.company_name')</th>
                                    <th>@lang('site.myjobs')</th>
                            ...
                            <tbody>
                                @foreach ($rows as $index => $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->fullName }}</td>
                                        <td>{{ $row->email }}</td>
                                        <th>{{ $row->mobile_number1}}</th>
                                        <td>{{ $row->company_name }}</td>
                                        <th><a href="{{route('dashboard.myComapnyJbos',$row->id)}}">{{$row->jobs()->count()}}</a></th>
                                        <td>
