...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-tasks"></i> @lang('site.'.$module_name_plural)</li>
        </ol>
    </section>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{++$index}}</td>
                            <td>{{$row->name}}</td>
                            <td> {{$row->parent_id !=null ? App\Models\Category::find($row->parent_id)->name : 'No Parent'}}</td>
                            <td>
